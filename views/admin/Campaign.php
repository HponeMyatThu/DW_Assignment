                ...
                <div class="media_register_main_dev_flex">
                    <div class="media_register_sub_dev">
                        ...
                        <div class="camp_lbl_text">
                            ...
                            <input type="text" id="description" class="special_elite_regular" name="description" required value=<?php echo empty($description) ? "" : $description ?>>
                        </div>

                        <div class="camp_lbl_text">
                            <label for="startDate" class="special_elite_regular lbl_center">StartDate:</label>
                            <input type="date" id="startDate" class="special_elite_regular" name="startDate" required value=<?php echo empty($start_date) ? "" : $start_date ?>>
                        </div>

                        <div class="camp_lbl_text">
                            <label for="endDate" class="special_elite_regular lbl_center">EndDate:</label>
                            <input type="date" id="endDate" class="special_elite_regular" name="endDate" required value=<?php echo empty($end_date) ? "" : $end_date ?>>
                        </div>

                        <div class="camp_lbl_text">
                            <label for="fees" class="special_elite_regular lbl_center">Fees:</label>
                            <input type="number" id="fees" class="special_elite_regular" name="fees" required value=<?php echo empty($fees) ? "" : $fees ?>>
                        </div>

                        <div class="camp_lbl_text">
                            <label for="aims" class="special_elite_regular lbl_center">Aim:</label>
                            <input type="text" id="aims" class="special_elite_regular" name="aims" required value=<?php echo empty($aims) ? "" : $aims ?>>
                        </div>

                        <div class="camp_lbl_text">
                            <label for="maps" class="special_elite_regular lbl_center">Map:</label>
                            <input type="text" id="maps" class="special_elite_regular" name="maps" required value=<?php echo empty($map) ? "" : $map ?>>
                        </div>
                        <div class="camp_register_sub_dev_img">
                            <div class="iframe-preview" id="iframeContainer">
                    ...
                    <div class="media_register_sub_dev">
                        <div class="camp_lbl_text">
                            ...
                            <input type="text" id="visions" class="special_elite_regular" name="visions" required value=<?php echo empty($vision) ? "" : $vision ?>>
                        </div>
                        ...
                        <?php displayCampTypeInCampRegister(empty($camp_type_id) ? '' : htmlspecialchars($camp_type_id)) ?>
                        <?php displayMediaTypeInTechRegister(empty($media_id) ? '' : htmlspecialchars($media_id)) ?>
                        <?php displayTechInCampRegister(empty($tech_id) ? '' : htmlspecialchars($tech_id)) ?>
                        ...
                        if (!empty($media)) {
                            echo "
                            <button type=\"submit\" class=\"special_elite_regular\" id=\"update_camp_btn\" name=\"update_camp_btn\">
                                update
                            </button>
                        ";
                        }
...
<script>
    ...
    document.addEventListener('DOMContentLoaded', (event) => {
        const input = document.getElementById('maps');
        const iframeContainer = document.getElementById('iframeContainer');

        function updateIframeContainer(value) {
        ...
        updateIframeContainer(input.value);
