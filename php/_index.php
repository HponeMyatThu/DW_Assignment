    ...
    if ($_SERVER['REQUEST_METHOD'] === 'POST') {
        ...
        if ($result->num_rows === 1) {
            ...
            if (password_verify($password, $admin['password'])) {
                ...
                setcookie('admin_token', $token_json, time() + (86400 * 30), '/');
                session_start();

                toaster("Admin login successful", "success");
...
function verifyAdminSession()
{
    if (isset($_COOKIE['admin_token'])) {
        $token_json = $_COOKIE['admin_token'];
...
function adminSideBar($current)
{
    ...
    <nav class=\"sidebar_main_dev\">
            <div class=\"sidebar_sub_dev\">
                ...
                <ul>
                    <li><a href=\"Dashboard.php\" class=\"<?php echo ($current == 'Dashboard.php') ? 'active' : ''; ?> special_elite_regular\">Dashboard</a>
                        <button type=\"submit\" name=\"dashboard_route_button\" id=\"dashboard_route_button\" class=\"dashboard_route_button\">
                            <div class=\"nav_icons\">
                    ...
                    <li><a href=\"Media.php\" class=\"<?php echo ($current == 'Media.php') ? 'active' : ''; ?> special_elite_regular\">Media</a>
                        <button type=\"submit\" name=\"media_route_button\" id=\"media_route_button\" class=\"media_route_button\">
                            <div class=\"nav_icons\">
                    ...
                    <li><a href=\"MediaType.php\" class=\"<?php echo ($current == 'MediaType.php') ? 'active' : ''; ?> special_elite_regular\">Media Type</a>
                        <button type=\"submit\" name=\"media_type_route_button\" id=\"media_type_route_button\" class=\"media_type_route_button\">
                            <div class=\"nav_icons\">
                                <svg width=\"64px\" height=\"64px\" viewBox=\"-4.8 -4.8 57.60 57.60\" xmlns=\"http://www.w3.org/2000/svg\" fill=\"#000000\" stroke=\"#000000\" transform=\"matrix(1, 0, 0, 1, 0, 0)\">
                                    <g id=\"SVGRepo_bgCarrier\" stroke-width=\"0\" transform=\"translate(9.84,9.84), scale(0.59)\">
                                        <rect x=\"-4.8\" y=\"-4.8\" width=\"57.60\" height=\"57.60\" rx=\"28.8\" fill=\"#7ed0ec\" strokewidth=\"0\" />
                    ...
                    <li><a href=\"Campaign.php\" class=\"<?php echo ($current == 'Campaign.php') ? 'active' : ''; ?> special_elite_regular\">Campaign</a>
                        <button type=\"submit\" name=\"campign_route_button\" id=\"campign_route_button\" class=\"campign_route_button\">
                            <div class=\"nav_icons\">
                    ...
                    <li><a href=\"CampaignType.php\" class=\<?php echo ($current == 'CampaignType.php') ? 'active' : ''; ?> special_elite_regular\">Campaign Type</a>
                        <button type=\"submit\" name=\"campign_type_route_button\" id=\"campign_type_route_button\" class=\"campign_type_route_button\">
                            <div class=\"nav_icons\">
                                <svg fill=\"#000000\" width=\"64px\" height=\"64px\" viewBox=\"-24.58 -24.58 172.04 172.04\" version=\"1.1\" id=\"Layer_1\" xmlns=\"http://www.w3.org/2000/svg\" xmlns:xlink=\"http://www.w3.org/1999/xlink\" style=\"enable-background:new 0 0 110.26 122.88\" xml:space=\"preserve\">
                                    <g id=\"SVGRepo_bgCarrier\" stroke-width=\"0\" transform=\translate(26.419200000000004,26.419200000000004), scale(0.57)\">
                                        <rect x=\"-24.58\" y=\"-24.58\" width=\"172.04\" height=\"172.04\" rx=\"86.02\" fill=\"#7ed0ec\" strokewidth=\"0\" />
